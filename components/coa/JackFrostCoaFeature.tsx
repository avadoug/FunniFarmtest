...
import { CoaImageViewer } from "@/components/coa/CoaImageViewer";
      ...
      <div className="grid gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-start">
        <div>
          <CoaImageViewer
            ...
            caption={jackFrostCoa.image.caption}
            fullSrc={jackFrostCoa.image.fullSrc}
            previewSrc={jackFrostCoa.image.previewSrc}
          />
        </div>
        ...
        <div>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <ButtonLink href={jackFrostCoa.image.fullSrc} target="_blank">
              View Full COA
            </ButtonLink>
