...
export const productLabelFacts: Record<string, ProductLabelFacts> = {
  "funni-farm-cbg-gummies": {
    ...
    image: "/images/products/funni-farm-cbg-gummies-label-facts.webp",
    imageAlt:
      "The Funni Farm CBG Gummies facts panel showing ingredients, suggested use, QR code area, and nutrition facts.",
    ...
    manufacturedBy: [
      "The Funni Farm",
      "3610 Lewis Atkins Rd.",
      "Woodlawn, TN 37191",
      "(931) 551-0899",
    ],
    labTransparency:
      "The label includes a scan area for Certificate of Analysis, cannabinoid profile, and third-party lab results, plus lab-tested quality language. Replace the placeholder site link with the current batch COA before live sales.",
    nutrition: [
