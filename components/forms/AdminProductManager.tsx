...
const blankProduct: ProductInput = {
  ...
  labTested: false,
  hempComplianceNote:
    "Placeholder: confirm federal hemp compliance with current COA and legal review.",
      ...
      <div className="mx-auto max-w-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="seed-card rounded-seed p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-forest-900/70">
            Placeholder guard only. Default local password is{" "}
            <code className="rounded bg-forest-900/10 px-1.5 py-1 font-black">
              funni-local-admin
            </code>
            . Replace with real authentication before deployment.
          </p>
          <form
