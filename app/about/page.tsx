...
export const metadata: Metadata = {
  title: "Our Story",
  description:
    "The story of The Funni Farm, a family-owned Tennessee hemp farm focused on quality, transparency, care, and independent lab testing.",
};

const storyParagraphs = [
  "The Funni Farm was born from a simple dream and a family determined to build something meaningful.",
  ...
  "Today, we're proud to be a family-owned Tennessee hemp farm. From cultivation to finished products, we focus on quality, transparency, and care every step of the way. Every batch is crafted with attention to detail and independently lab tested so you can shop with confidence.",
...
const values = [
  ...
  },
  {
    icon: FlaskConical,
    title: "Lab Tested",
    text: "Every batch is crafted with attention to detail and sent for independent lab testing.",
  },
  {
    icon: HeartHandshake,
    title: "Honest Care",
    ...
    <div>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[.82fr_1.18fr] lg:px-8">
          ...
          <div className="flex flex-col justify-center">
            <SectionHeading
              eyebrow="Our Story"
              title="A family farm with a new chapter."
            >
              <p>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-4 max-w-3xl leading-7 text-forest-900/72">
          ...
          transparency, independent lab testing, and care from cultivation to
          finished product.
        </p>
